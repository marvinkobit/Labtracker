               ...
               <br />
                   <asp:GridView ID="gvResult" runat="server" style="font-size:12px" width="1200px" CellPadding="3" AutoGenerateColumns="False" DataKeyNames="SampleID" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True" AutoGenerateEditButton="True" AutoGenerateDeleteButton="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" OnDataBound="gvResult_DataBound" >
                      <Columns>
                          ...
                          <asp:BoundField DataField="RD9_res" HeaderText="RD9_res" SortExpression="RD9_res" />
                          <asp:BoundField DataField="Smear_res" HeaderText="Smear_res" SortExpression="Smear_res" />
                          <asp:BoundField DataField="LJ_res" HeaderText="LJ_res" SortExpression="LJ_res" />
                          <asp:BoundField DataField="MIJT_res" HeaderText="MIJT_res" SortExpression="MIJT_res" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Labtracker %>" SelectCommand="SELECT [ResultID],[RD9_res],[Smear_res],[LJ_res],[MIJT_res],[res1],[res2],[SampleID] FROM [Results]"></asp:SqlDataSource>
