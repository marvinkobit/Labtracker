        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
               <br />
                   <asp:GridView ID="gvResult" runat="server" style="font-size:12px" width="1200px" CellPadding="3" AutoGenerateColumns="False" DataKeyNames="PatientId" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True" AutoGenerateEditButton="True" AutoGenerateDeleteButton="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" OnDataBound="gvResult_DataBound" >
                      <Columns>
                          ...
                          <asp:BoundField DataField="CultureSmear_res" HeaderText="Culture Smear" SortExpression="CultureSmear_res" />
                           ...
                           <asp:BoundField DataField="LabInitial" HeaderText="Initial" SortExpression="Initial" />
          ...
          <!-- Content Row -->
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
               <br />
                   <asp:GridView ID="gvDstResult" runat="server" style="font-size:12px" width="1200px" CellPadding="3" AutoGenerateColumns="False" DataKeyNames="PatientId" DataSourceID="SqlDataSource2" AllowPaging="True" AllowSorting="True" AutoGenerateEditButton="True" AutoGenerateDeleteButton="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" OnDataBound="gvDstResult_DataBound" >
                      <Columns>
                          <asp:CommandField ShowSelectButton="True" />
                          <%--<asp:BoundField DataField="ResultID" HeaderText="ResultID" InsertVisible="False" ReadOnly="True" SortExpression="ResultID" />--%>
                          <asp:BoundField DataField="PatientId" HeaderText="PatientId" SortExpression="PatientId" />
