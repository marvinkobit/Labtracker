            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
               <br />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Labtracker %>" SelectCommand="SELECT TOP 1 r1.[Smear_res],r2.[HeatKilled_res],r1.[SampleID],r3.[RD9_res],r4.[LJ_res],r5.[MIJT_res],r6.[CultureSmear_res],r7.[Spoligo_res] 
FROM Results r1, Results r2, Results r3, Results r4, Results r5, Results r6, Results r7
WHERE r1.SampleID = r2.SampleID AND r1.SampleID = r3.SampleID AND r1.SampleID = r4.SampleID AND r1.SampleID = r5.SampleID AND r1.SampleID = r6.SampleID AND r1.SampleID = r7.SampleID
ORDER BY ( (case when r1.[Smear_res] is null then 1 else 0 end) +
           (case when r2.[HeatKilled_res] is null then 1 else 0 end) + 
		   (case when r3.[RD9_res] is null then 1 else 0 end) +
		   (case when r4.[LJ_res] is null then 1 else 0 end) +
		   (case when r5.[MIJT_res] is null then 1 else 0 end) +
		   (case when r6.[CultureSmear_res] is null then 1 else 0 end) +
		   (case when r7.[Spoligo_res] is null then 1 else 0 end) 
          ...
          <!-- Content Row -->
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
               <br />
                   <asp:GridView ID="gvDstResult" runat="server" style="font-size:12px" width="1200px" CellPadding="3" AutoGenerateColumns="False" DataKeyNames="SampleID" DataSourceID="SqlDataSource2" AllowPaging="True" AllowSorting="True" AutoGenerateEditButton="True" AutoGenerateDeleteButton="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" OnDataBound="gvDstResult_DataBound" >
                      <Columns>
                          <asp:CommandField ShowSelectButton="True" />
                          <%--<asp:BoundField DataField="ResultID" HeaderText="ResultID" InsertVisible="False" ReadOnly="True" SortExpression="ResultID" />--%>
                          <asp:BoundField DataField="SampleID" HeaderText="SampleID" SortExpression="SampleID" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Labtracker %>" SelectCommand="SELECT DstID,SampleID,DrugLine,Drug,Sensitivity,Dater,Initial FROM Dsts"></asp:SqlDataSource>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
               <br />
                   <asp:GridView ID="gvGrowthResult" runat="server" style="font-size:12px" width="1200px" CellPadding="3" AutoGenerateColumns="False" DataKeyNames="SampleID" DataSourceID="SqlDataSource3" AllowPaging="True" AllowSorting="True" AutoGenerateEditButton="True" AutoGenerateDeleteButton="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" OnDataBound="gvGrowthResult_DataBound" >
                      <Columns>
                          <asp:CommandField ShowSelectButton="True" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Labtracker %>" SelectCommand="SELECT GrowthID,SampleID,Week,dat1,dat2,Dater,Initial FROM Growths"></asp:SqlDataSource>
