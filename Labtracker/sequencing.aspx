            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <i class="fas fa-download fa-sm text-white-50"></i> Upload from file</a>--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-8">
                                ...
                                <div class="card shadow mb-4 table-responsive">
                                    <p>DNA Extraction:
                                        <asp:Label runat="server" ID="lbldnasall"></asp:Label>
                                        extracts,
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-4">
                                <asp:DropDownList ID="ddlCOlVal" runat="server" Height="26px" Width="155px" DataTextField="column_name" DataValueField="column_name">
                                    ...
                                    <asp:ListItem>TubeLabel</asp:ListItem>
                                    <asp:ListItem>Initial</asp:ListItem>
                                    <asp:ListItem>GoodQQ</asp:ListItem>
                                    <asp:ListItem>SampleType</asp:ListItem>
                                    <asp:ListItem>AssayReagent</asp:ListItem>
                                    <asp:ListItem>QubitConc</asp:ListItem>
                                    <asp:ListItem>NDConc</asp:ListItem>
                                    <asp:ListItem>Purity</asp:ListItem>

                                </asp:DropDownList>


                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Labtracker %>" SelectCommand="select column_name from information_schema.columns where table_name = 'Dnaextracts'"></asp:SqlDataSource>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-8">
                                <div class="card shadow mb-4 table-responsive">
                                    <p>Library Preparation
                                        <asp:Label runat="server" ID="lblLibraryprep" Text=""></asp:Label></p>
                                    <asp:GridView ID="GridView1" runat="server" Style="font-size: 12px" Width="1200px" CellPadding="3" AutoGenerateColumns="False" DataKeyNames="PatientId" DataSourceID="SqlDataSource2" AllowPaging="True" AllowSorting="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" OnDataBound="gvDnaResult_DataBound">
                                        <Columns>
                                            <asp:CommandField ShowSelectButton="True" />
                                            <%--<asp:BoundField DataField="ResultID" HeaderText="ResultID" InsertVisible="False" ReadOnly="True" SortExpression="ResultID" />--%>
                                            <asp:BoundField DataField="PatientId" HeaderText="PatientId" SortExpression="PatientId" />
