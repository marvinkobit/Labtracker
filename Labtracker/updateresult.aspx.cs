...
namespace Labtracker
{
    public partial class updateresult : System.Web.UI.Page
    {
        ...
        protected void btnSaveas_Click(object sender, EventArgs e)
        {
            ...
            string selectedres = ddlRegion.SelectedItem.ToString();
            string selectedvalue = ddlZone.SelectedItem.ToString();
            asSavelbl.Text = String.Format("Unable to add new Update to database. {0}{1}", selectedvalue, selectedres);
            //switch (selectedres)
            //{
            //    case "Primary Smear":
