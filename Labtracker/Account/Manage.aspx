<%@ Page Title="Manage Account" Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Labtracker.Account.Manage" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <title>TBGEN LabTracker - Manage</title>
        ...
        <div class="col-md-12">
            <div class="form-horizontal">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd><%: LoginsCount %>
                        <asp:HyperLink NavigateUrl="#" Text="[Manage]" runat="server" />
